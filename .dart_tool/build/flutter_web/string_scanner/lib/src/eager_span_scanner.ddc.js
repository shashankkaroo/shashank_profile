define(['dart_sdk', 'packages/source_span/source_span'], function(dart_sdk, packages__source_span__source_span) {
  ...
  const _scanner$1 = Symbol("_EagerSpanScannerState._scanner");
  ...
  const _scanner$3 = Symbol("_SpanScannerState._scanner");
  ...
  const _scanner$4 = Symbol("_SpanScannerState._scanner");
