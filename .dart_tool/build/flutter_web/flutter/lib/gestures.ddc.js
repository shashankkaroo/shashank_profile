define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/flutter/src/gestures/arena', 'packages/collection/src/priority_queue'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__flutter__src__gestures__arena, packages__collection__src__priority_queue) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    ...
    get C4() {
      return C4 = dart.const({
        __proto__: platform_views._AndroidViewState.prototype,
        [_name$]: "_AndroidViewState.createFailed",
        index: 3
      });
    },
    get C5() {
    ...
    get C6() {
      return C6 = dart.constList([C1 || CT.C1, C2 || CT.C2, C3 || CT.C3, C4 || CT.C4, C5 || CT.C5], platform_views._AndroidViewState);
    },
    get C7() {
    ...
    get C10() {
      return C10 = dart.const({
        __proto__: binding$0.SchedulerPhase.prototype,
        [_name$0]: "SchedulerPhase.transientCallbacks",
        index: 1
      });
    },
    get C11() {
      return C11 = dart.const({
        __proto__: binding$0.SchedulerPhase.prototype,
        [_name$0]: "SchedulerPhase.midFrameMicrotasks",
        index: 2
      });
    },
    get C12() {
      return C12 = dart.const({
        __proto__: binding$0.SchedulerPhase.prototype,
        [_name$0]: "SchedulerPhase.persistentCallbacks",
        index: 3
      });
    },
    get C13() {
      return C13 = dart.const({
        __proto__: binding$0.SchedulerPhase.prototype,
        [_name$0]: "SchedulerPhase.postFrameCallbacks",
        index: 4
      });
    },
    get C14() {
      return C14 = dart.constList([C9 || CT.C9, C10 || CT.C10, C11 || CT.C11, C12 || CT.C12, C13 || CT.C13], binding$0.SchedulerPhase);
    },
    get C15() {
      return C15 = dart.fn(binding$0.defaultSchedulingStrategy, __Tobool());
    },
    get C16() {
      return C16 = dart.fn(binding$0.SchedulerBinding._taskSorter, _TaskEntryAnd_TaskEntryToint());
    },
    get C17() {
  ...
  platform_views.PlatformViewsRegistry = class PlatformViewsRegistry extends core.Object {
    getNextPlatformViewId() {
      ...
      this[_nextPlatformViewId] = dart.notNull(t0) + 1;
      return t0;
    }
  };
  ...
  const _name$ = dart.privateName(platform_views, "_name");
  let C1;
  let C2;
  let C3;
  let C4;
  ...
  platform_views._AndroidViewState.waitingForSize = C1 || CT.C1;
  platform_views._AndroidViewState.creating = C2 || CT.C2;
  platform_views._AndroidViewState.created = C3 || CT.C3;
  platform_views._AndroidViewState.createFailed = C4 || CT.C4;
  platform_views._AndroidViewState.disposed = C5 || CT.C5;
  platform_views._AndroidViewState.values = C6 || CT.C6;
  ...
  const _name$0 = dart.privateName(binding$0, "_name");
  let C9;
  let C10;
  let C11;
  let C12;
  ...
  binding$0.SchedulerPhase.idle = C9 || CT.C9;
  binding$0.SchedulerPhase.transientCallbacks = C10 || CT.C10;
  binding$0.SchedulerPhase.midFrameMicrotasks = C11 || CT.C11;
  binding$0.SchedulerPhase.persistentCallbacks = C12 || CT.C12;
  binding$0.SchedulerPhase.postFrameCallbacks = C13 || CT.C13;
  binding$0.SchedulerPhase.values = C14 || CT.C14;
  ...
  binding$0.SchedulerBinding[dart.mixinOn] = _SchedulerBinding$BindingBase$ServicesBinding => class SchedulerBinding extends _SchedulerBinding$BindingBase$ServicesBinding {
    ...
    scheduleFrame() {
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 713, 12, " assert(() {\n      if (debugPrintScheduleFrameStacks)\n        debugPrintStack(label: 'scheduleFrame() called. Current phase is $schedulerPhase.');\n      return true;");
    ...
    scheduleForcedFrame() {
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 744, 12, " assert(() {\n      if (debugPrintScheduleFrameStacks)\n        debugPrintStack(label: 'scheduleForcedFrame() called. Current phase is $schedulerPhase.');\n      return true;");
      this.window.scheduleFrame();
      this[_hasScheduledFrame] = true;
    }
    scheduleWarmUpFrame() {
      ...
      async.Timer.run(dart.fn(() => {
        if (!dart.test(this[_warmUpFrame])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 779, 14, " assert(_war");
        this.handleBeginFrame(null);
      }, VoidToNull()));
      async.Timer.run(dart.fn(() => {
        if (!dart.test(this[_warmUpFrame])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 783, 14, " assert(_war");
    ...
    get currentFrameTimeStamp() {
      if (!(this[_currentFrameTimeStamp] != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 852, 12, " assert(_currentFrameTimeStamp");
      return this[_currentFrameTimeStamp];
    }
    get currentSystemFrameTimeStamp() {
      if (!(this[_lastRawTimeStamp] != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 869, 12, " assert(_lastRawTimeStamp");
      return this[_lastRawTimeStamp];
    }
    [_handleBeginFrame](rawTimeStamp) {
      if (dart.test(this[_warmUpFrame])) {
        if (!!dart.test(this[_ignoreNextEngineDrawFrame])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 879, 14, " assert(!_ignoreNextEngineD");
    ...
    handleBeginFrame(rawTimeStamp) {
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 924, 12, " assert(() {\n      _debugFrameNumber += 1;\n\n      if (debugPrintBeginFrameBanner || debugPrintEndFrameBanner) {\n        final StringBuffer frameTimeStampDescription = StringBuffer();\n        if (rawTimeStamp != null) {\n          _debugDescribeTimeStamp(_currentFrameTimeStamp, frameTimeStampDescription);\n        } else {\n          frameTimeStampDescription.write('(warm-up frame)');\n        }\n        _debugBanner = '▄▄▄▄▄▄▄▄ Frame ${_debugFrameNumber.toString().padRight(7)}   ${frameTimeStampDescription.toString().padLeft(18)} ▄▄▄▄▄▄▄▄';\n        if (debugPrintBeginFrameBanner)\n          debugPrint(_debugBan");
      if (!dart.equals(this.schedulerPhase, binding$0.SchedulerPhase.idle)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 941, 12, "     return true;\n    }());\n\n    asse");
    ...
    handleDrawFrame() {
      if (!dart.equals(this[_schedulerPhase], binding$0.SchedulerPhase.midFrameMicrotasks)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 969, 12, ".\n  void handleDrawFrame() {\n    assert(_schedulerPh");
      developer.Timeline.finishSync();
      try {
        ...
        if (!dart.test(dart.fn(() => {
          ...
          return true;
        }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 987, 14, "shSync(); // end the Frame\n      assert(() {\n        if (debugPrintEndFrameBanner)\n          debugPrint('▀' * _debugBanner.length);\n        _debugBan");
    ...
    [_invokeFrameCallback](callback, timeStamp, callbackStack) {
      ...
      if (!(callback != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1029, 12, " StackTrace call");
      if (!(binding$0._FrameCallbackEntry.debugCurrentCallbackStack == null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1030, 12, "\n    assert(callback != null);\n    assert(_FrameCallb");
      if (!dart.test(dart.fn(() => {
        binding$0._FrameCallbackEntry.debugCurrentCallbackStack = callbackStack;
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1031, 12, "CurrentCallbackStack == null);\n    assert(() { _FrameCallbackEntry.debugCurrentCallb");
      try {
        callback(timeStamp);
      } catch (e) {
        let exception = dart.getThrown(e);
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1050, 12, " );\n        },\n      ));\n    }\n    assert(() { _FrameCallbackEntry.debugCur");
    }
  };
  (binding$0.SchedulerBinding[dart.mixinNew] = function() {
    this[_lifecycleState] = null;
    this[schedulingStrategy] = C15 || CT.C15;
    this[_taskQueue] = new (HeapPriorityQueueOf_TaskEntry()).new(C16 || CT.C16);
    this[_hasRequestedAnEventLoopCallback] = false;
  ...
  mouse_tracking.MouseTracker = class MouseTracker extends change_notifier.ChangeNotifier {
    ...
    detachAnnotation(annotation) {
      ...
      for (let deviceId of trackedAnnotation.activeDevices) {
        if (annotation.onExit != null) {
          ...
          if (!(event != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 129, 16, "event != null");
    ...
    [_scheduleMousePositionCheck]() {
      if (dart.test(this[_trackedAnnotations][$isNotEmpty]) && !dart.test(this[_postFrameCheckScheduled])) {
        ...
        binding$0.SchedulerBinding.instance.addPostFrameCallback(dart.fn(_ => {
          this[_postFrameCheckScheduled] = false;
          this.collectMousePositions();
        }, DurationToNull()));
        binding$0.SchedulerBinding.instance.scheduleFrame();
      }
    }
    [_handleEvent](event) {
    ...
    [_findAnnotation](annotation) {
      ...
      if (!(trackedAnnotation != null)) dart.assertFailed("Unable to find annotation " + dart.str(annotation) + " in tracked annotations. " + "Check that attachAnnotation has been called for all annotated layers.", "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 183, 9, "trackedAnnotation != null");
    ...
    collectMousePositions() {
      ...
      const exitAnnotation = (trackedAnnotation, deviceId) => {
        ...
        if ((t2 = trackedAnnotation.annotation, t2 == null ? null : t2.onExit) != null && dart.test(trackedAnnotation.activeDevices.contains(deviceId))) {
          let event = (t2$ = this[_lastMouseEvent][$_get](deviceId), t2$ == null ? this[_pendingRemovals][$_get](deviceId) : t2$);
          if (!(event != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 213, 16, "event != null");
    ...
    [_removeMouseEvent](deviceId, event) {
      let wasConnected = this.mouseIsConnected;
      if (!events.PointerRemovedEvent.is(event)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 299, 12, "event is PointerRemovedEvent");
  ...
  (mouse_tracking.MouseTracker.new = function(router, annotationFinder) {
    ...
    if (!(router != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 96, 16, "router != null");
