define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/flutter/src/semantics/binding', 'packages/flutter/gestures', 'packages/flutter/src/physics/clamped_simulation'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__flutter__src__semantics__binding, packages__flutter__gestures, packages__flutter__src__physics__clamped_simulation) {
  ...
  dart.defineLazy(CT, {
    ...
    get C4() {
      return C4 = dart.const({
        ...
        [_name$0]: "_AnimationDirection.forward",
        index: 0
      });
    },
    get C5() {
      return C5 = dart.const({
        __proto__: animation_controller._AnimationDirection.prototype,
        [_name$0]: "_AnimationDirection.reverse",
        index: 1
      });
    },
    get C6() {
      return C6 = dart.constList([C4 || CT.C4, C5 || CT.C5], animation_controller._AnimationDirection);
    },
    get C7() {
      return C7 = dart.const({
        __proto__: animation_controller.AnimationBehavior.prototype,
        [_name$0]: "AnimationBehavior.normal",
        index: 0
      });
    },
    get C8() {
      return C8 = dart.const({
        __proto__: animation_controller.AnimationBehavior.prototype,
        [_name$0]: "AnimationBehavior.preserve",
        index: 1
      });
    },
    get C9() {
      return C9 = dart.constList([C7 || CT.C7, C8 || CT.C8], animation_controller.AnimationBehavior);
    },
    get C10() {
    ...
    get C12() {
      return C12 = dart.const({
        ...
        [_name$1]: "_TrainHoppingMode.minimize",
        index: 0
      });
    },
    get C13() {
      return C13 = dart.const({
        __proto__: animations._TrainHoppingMode.prototype,
        [_name$1]: "_TrainHoppingMode.maximize",
        index: 1
      });
    },
    get C14() {
      return C14 = dart.constList([C12 || CT.C12, C13 || CT.C13], animations._TrainHoppingMode);
    },
    get C15() {
    ...
    get C57() {
      return C57 = dart.constList([C3 || CT.C3, C0 || CT.C0, C1 || CT.C1, C2 || CT.C2], animation$.AnimationStatus);
    }
  });
  ...
  const _name$0 = dart.privateName(animation_controller, "_name");
  let C4;
  let C5;
  let C6;
  ...
  animation_controller._AnimationDirection.forward = C4 || CT.C4;
  animation_controller._AnimationDirection.reverse = C5 || CT.C5;
  animation_controller._AnimationDirection.values = C6 || CT.C6;
  let C7;
  let C8;
  let C9;
  ...
  animation_controller.AnimationBehavior.normal = C7 || CT.C7;
  animation_controller.AnimationBehavior.preserve = C8 || CT.C8;
  animation_controller.AnimationBehavior.values = C9 || CT.C9;
  ...
  animation_controller.AnimationController = class AnimationController extends Animation_AnimationLocalStatusListenersMixin$ {
    get lowerBound() {
    ...
    animateTo(target, opts) {
      ...
      let curve = opts && 'curve' in opts ? opts.curve : C10 || CT.C10;
    ...
    repeat(opts) {
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 612, 12, "() {\n      if (period == null) {\n        throw FlutterError(\n          'AnimationController.repeat() called without an explicit period and with no default Duration.\\n'\n          'Either the \"period\" argument to the repeat() method should be provided, or the '\n          '\"duration\" property should be set, either in the constructor or later, before '\n          'calling the repeat() function.'\n        );\n      }\n      return true;\n    }()");
      if (!(dart.notNull(max) >= dart.notNull(min))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 623, 12, "max >= min");
      if (!(dart.notNull(max) <= dart.notNull(this.upperBound) && dart.notNull(min) >= dart.notNull(this.lowerBound))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 624, 12, "max <= upperBound && min >= lowerBound");
      if (!(reverse != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 625, 12, "reverse != null");
      return this.animateWith(new animation_controller._RepeatingSimulation.new(this[_value], min, max, reverse, period));
    }
    fling(opts) {
      let t0, t0$;
      ...
      let simulation = (t0$ = new spring_simulation.SpringSimulation.new(animation_controller._kFlingSpringDescription, this.value, target, dart.notNull(velocity) * scale), t0$.tolerance = animation_controller._kFlingTolerance, t0$);
      return this.animateWith(simulation);
    }
    animateWith(simulation) {
      if (!(this[_ticker] != null)) dart.assertFailed("AnimationController.animateWith() called after AnimationController.dispose()\n" + "AnimationController methods should not be used after calling dispose.", "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 671, 7, "_ticker != null");
      this.stop();
      return this[_startSimulation](simulation);
    }
    [_startSimulation](simulation) {
      if (!(simulation != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 680, 12, "simulation != null");
      if (!!dart.test(this.isAnimating)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 681, 12, "!isAnimating");
    ...
    stop(opts) {
      ...
      if (!(this[_ticker] != null)) dart.assertFailed("AnimationController.stop() called after AnimationController.dispose()\n" + "AnimationController methods should not be used after calling dispose.", "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 712, 7, "_ticker != null");
    ...
    [_tick](elapsed) {
      ...
      if (!(elapsedInSeconds >= 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 760, 12, "elapsedInSeconds >= 0.0");
  ...
  (animation_controller.AnimationController.new = function(opts) {
    ...
    let animationBehavior = opts && 'animationBehavior' in opts ? opts.animationBehavior : C7 || CT.C7;
  ...
  (animation_controller.AnimationController.unbounded = function(opts) {
    ...
    let debugLabel = opts && 'debugLabel' in opts ? opts.debugLabel : null;
    let vsync = opts && 'vsync' in opts ? opts.vsync : null;
    let animationBehavior = opts && 'animationBehavior' in opts ? opts.animationBehavior : C8 || CT.C8;
    this[_ticker] = null;
    this[_simulation] = null;
    this[_value] = null;
    this[_lastElapsedDuration] = null;
  ...
  const lowerBound$ = Symbol("AnimationController.lowerBound");
  const upperBound$ = Symbol("AnimationController.upperBound");
  const debugLabel$ = Symbol("AnimationController.debugLabel");
  const animationBehavior$ = Symbol("AnimationController.animationBehavior");
  const duration$ = Symbol("AnimationController.duration");
  const reverseDuration$ = Symbol("AnimationController.reverseDuration");
  ...
  (animation_controller._InterpolationSimulation.new = function(_begin, _end, duration, _curve, scale) {
    ...
    this[_end$] = _end;
    this[_curve$] = _curve;
    if (!(_begin != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 784, 14, "_begin != null");
    if (!(_end != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 785, 14, "_end != null");
    if (!(duration != null && dart.notNull(duration.inMicroseconds) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 786, 14, "duration != null && duration.inMicroseconds > 0");
  ...
  animation_controller._RepeatingSimulation = class _RepeatingSimulation extends simulation.Simulation {
    x(timeInSeconds) {
      if (!(dart.notNull(timeInSeconds) >= 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 832, 12, "timeInSeconds >= 0.0");
  ...
  (animation_controller._RepeatingSimulation.new = function(initialValue, min, max, reverse, period) {
    this.min = min;
    this.max = max;
    ...
    if (!(dart.notNull(this[_periodInSeconds]) > 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 819, 12, "_periodInSeconds > 0.0");
    if (!(dart.notNull(this[_initialT]) >= 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/animation/animation_controller.dart", 820, 12, "_initialT >= 0.0");
  ...
  dart.applyMixin(Animation_AnimationLazyListenerMixin$$, listener_helpers.AnimationLazyListenerMixin);
  const Animation_AnimationLocalStatusListenersMixin$$0 = class Animation_AnimationLocalStatusListenersMixin extends Animation_AnimationLazyListenerMixin$$ {};
  ...
  animations.ReverseAnimation = class ReverseAnimation extends Animation_AnimationLocalStatusListenersMixin$$0 {
    get parent() {
      return this[parent$];
    }
    set parent(value) {
  ...
  const curve$0 = Symbol("CurvedAnimation.curve");
  ...
  const _name$1 = dart.privateName(animations, "_name");
  let C12;
  let C13;
  let C14;
  ...
  animations._TrainHoppingMode.minimize = C12 || CT.C12;
  animations._TrainHoppingMode.maximize = C13 || CT.C13;
  animations._TrainHoppingMode.values = C14 || CT.C14;
  ...
  dart.applyMixin(Animation_AnimationEagerListenerMixin$$, listener_helpers.AnimationEagerListenerMixin);
  const Animation_AnimationLocalListenersMixin$$0 = class Animation_AnimationLocalListenersMixin extends Animation_AnimationEagerListenerMixin$$ {};
  (Animation_AnimationLocalListenersMixin$$0.new = function() {
    listener_helpers.AnimationLocalListenersMixin[dart.mixinNew].call(this);
    Animation_AnimationLocalListenersMixin$$0.__proto__.new.call(this);
  }).prototype = Animation_AnimationLocalListenersMixin$$0.prototype;
  dart.applyMixin(Animation_AnimationLocalListenersMixin$$0, listener_helpers.AnimationLocalListenersMixin);
  const Animation_AnimationLocalStatusListenersMixin$$1 = class Animation_AnimationLocalStatusListenersMixin extends Animation_AnimationLocalListenersMixin$$0 {};
  (Animation_AnimationLocalStatusListenersMixin$$1.new = function() {
    listener_helpers.AnimationLocalStatusListenersMixin[dart.mixinNew].call(this);
    Animation_AnimationLocalStatusListenersMixin$$1.__proto__.new.call(this);
  }).prototype = Animation_AnimationLocalStatusListenersMixin$$1.prototype;
  dart.applyMixin(Animation_AnimationLocalStatusListenersMixin$$1, listener_helpers.AnimationLocalStatusListenersMixin);
  animations.TrainHoppingAnimation = class TrainHoppingAnimation extends Animation_AnimationLocalStatusListenersMixin$$1 {
    get onSwitchedTrain() {
  ...
  animation$.AnimationStatus.values = C57 || CT.C57;
