define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/flutter/src/gestures/arena', 'packages/flutter/src/painting/_network_image_web', 'packages/vector_math/vector_math_64'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__flutter__src__gestures__arena, packages__flutter__src__painting___network_image_web, packages__vector_math__vector_math_64) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C1 = dart.constList([], diagnostics.DiagnosticsNode);
    },
    get C2() {
      return C2 = dart.constList([], semantics.SemanticsNode);
    },
    get C3() {
    ...
    get C7() {
      return C7 = dart.constList([C6 || CT.C6, C4 || CT.C4], semantics.DebugSemanticsDumpOrder);
    },
    get C8() {
  ...
  semantics_event.SemanticsEvent = class SemanticsEvent extends core.Object {
    ...
    toString() {
      ...
      let sortedKeys = (t0 = dataMap[$keys][$toList](), t0[$sort](), t0);
  ...
  const type$ = Symbol("SemanticsEvent.type");
  ...
  const message$ = Symbol("AnnounceSemanticsEvent.message");
  const textDirection$ = Symbol("AnnounceSemanticsEvent.textDirection");
  ...
  const message$0 = Symbol("TooltipSemanticsEvent.message");
  ...
  const name$ = Symbol("SemanticsTag.name");
  ...
  const label$ = Symbol("CustomSemanticsAction.label");
  const hint$ = Symbol("CustomSemanticsAction.hint");
  const action$ = Symbol("CustomSemanticsAction.action");
  ...
  semantics.SemanticsData = class SemanticsData extends diagnostics.Diagnosticable {
    ...
    debugFillProperties(properties) {
      ...
      for (let action of ui.SemanticsAction.values[$values]) {
        if ((dart.notNull(this.actions) & dart.notNull(action.index)) !== 0) actionSummary[$add](diagnostics.describeEnum(action));
      }
      ...
      for (let flag of ui.SemanticsFlag.values[$values]) {
        if ((dart.notNull(this.flags) & dart.notNull(flag.index)) !== 0) flagSummary[$add](diagnostics.describeEnum(flag));
      }
      ...
      if (dart.equals((t0 = this.textSelection, t0 == null ? null : t0.isValid), true)) properties.add(new diagnostics.MessageProperty.new("textSelection", "[" + dart.str(this.textSelection.start) + ", " + dart.str(this.textSelection.end) + "]"));
  ...
  (semantics.SemanticsData.new = function(opts) {
    ...
    if (!(flags != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 203, 15, "flags != null");
    if (!(actions != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 204, 15, "actions != null");
    if (!(label != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 205, 15, "label != null");
    if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 206, 15, "value != null");
    if (!(decreasedValue != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 207, 15, "decreasedValue != null");
    if (!(increasedValue != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 208, 15, "increasedValue != null");
    if (!(hint != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 209, 15, "hint != null");
    if (!(label === "" || textDirection != null)) dart.assertFailed("A SemanticsData object with label \"" + dart.str(label) + "\" had a null textDirection.", "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 210, 15, "label == '' || textDirection != null");
    if (!(value === "" || textDirection != null)) dart.assertFailed("A SemanticsData object with value \"" + dart.str(value) + "\" had a null textDirection.", "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 211, 15, "value == '' || textDirection != null");
    if (!(hint === "" || textDirection != null)) dart.assertFailed("A SemanticsData object with hint \"" + dart.str(hint) + "\" had a null textDirection.", "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 212, 15, "hint == '' || textDirection != null");
    if (!(decreasedValue === "" || textDirection != null)) dart.assertFailed("A SemanticsData object with decreasedValue \"" + dart.str(decreasedValue) + "\" had a null textDirection.", "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 213, 15, "decreasedValue == '' || textDirection != null");
    if (!(increasedValue === "" || textDirection != null)) dart.assertFailed("A SemanticsData object with increasedValue \"" + dart.str(increasedValue) + "\" had a null textDirection.", "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 214, 15, "increasedValue == '' || textDirection != null");
    if (!(rect != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 215, 15, "rect != null");
  ...
  const flags$ = Symbol("SemanticsData.flags");
  const actions$ = Symbol("SemanticsData.actions");
  const label$0 = Symbol("SemanticsData.label");
  const value$ = Symbol("SemanticsData.value");
  const increasedValue$ = Symbol("SemanticsData.increasedValue");
  const decreasedValue$ = Symbol("SemanticsData.decreasedValue");
  const hint$0 = Symbol("SemanticsData.hint");
  const textDirection$0 = Symbol("SemanticsData.textDirection");
  const textSelection$ = Symbol("SemanticsData.textSelection");
  const scrollChildCount$ = Symbol("SemanticsData.scrollChildCount");
  const scrollIndex$ = Symbol("SemanticsData.scrollIndex");
  const scrollPosition$ = Symbol("SemanticsData.scrollPosition");
  const scrollExtentMax$ = Symbol("SemanticsData.scrollExtentMax");
  const scrollExtentMin$ = Symbol("SemanticsData.scrollExtentMin");
  const platformViewId$ = Symbol("SemanticsData.platformViewId");
  const rect$ = Symbol("SemanticsData.rect");
  const tags$ = Symbol("SemanticsData.tags");
  const transform$ = Symbol("SemanticsData.transform");
  const elevation$ = Symbol("SemanticsData.elevation");
  const thickness$ = Symbol("SemanticsData.thickness");
  const customSemanticsActionIds$ = Symbol("SemanticsData.customSemanticsActionIds");
  ...
  let C5;
  let C6;
  const AbstractNode_DiagnosticableTreeMixin$ = class AbstractNode_DiagnosticableTreeMixin extends node.AbstractNode {};
  (AbstractNode_DiagnosticableTreeMixin$.new = function() {
    AbstractNode_DiagnosticableTreeMixin$.__proto__.new.call(this);
  }).prototype = AbstractNode_DiagnosticableTreeMixin$.prototype;
  dart.applyMixin(AbstractNode_DiagnosticableTreeMixin$, diagnostics.DiagnosticableTreeMixin);
  semantics.SemanticsNode = class SemanticsNode extends AbstractNode_DiagnosticableTreeMixin$ {
    get key() {
      return this[key$];
    }
    set key(value) {
    ...
    set rect(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1174, 12, "value != null");
      if (!dart.test(value.isFinite)) dart.assertFailed(dart.str(this) + " (with " + dart.str(this.owner) + ") tried to set a non-finite rect.", "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1175, 12, "value.isFinite");
    ...
    set isMergedIntoParent(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1259, 12, "ert(value != ");
    ...
    [_replaceChildren](newChildren) {
      let t2;
      if (!!dart.test(newChildren[$any](dart.fn(child => dart.equals(child, this), SemanticsNodeTobool())))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1293, 12, "ert(!newChildren.any((SemanticsNode child) => child == t");
      if (!dart.test(dart.fn(() => {
      ...
      if (newChildren != null) {
        for (let child of newChildren) {
          if (!!dart.test(child.isInvisible)) dart.assertFailed("Child " + dart.str(child) + " is invisible and should not be added as a child of " + dart.str(this) + ".", "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1347, 16, "ert(!child.isInvis");
          child[_dead] = false;
        }
      }
      let sawChange = false;
        ...
        for (let child of newChildren) {
          if (!dart.equals(child.parent, this)) {
            if (child.parent != null) {
              t2 = child.parent;
              t2 == null ? null : t2.dropChild(child);
            }
            if (!!dart.test(child.attached)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1375, 18, "ert(!child.atta");
      ...
      if (!sawChange && this[_children] != null) {
        if (!(newChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1382, 14, "ert(newChildren != ");
        if (!(newChildren[$length] == this[_children][$length])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1383, 14, "ert(newChildren.length == _children.le");
    ...
    get hasChildren() {
      let t2, t2$;
      t2$ = (t2 = this[_children], t2 == null ? null : t2[$isNotEmpty]);
    ...
    redepthChildren() {
      let t2;
      t2 = this[_children];
      t2 == null ? null : t2[$forEach](dart.bind(this, 'redepthChild'));
    }
    attach(owner) {
      semantics.SemanticsOwner._check(owner);
      super.attach(owner);
      if (!!dart.test(owner[_nodes][$containsKey](this.id))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1449, 12, "ert(!owner._nodes.containsKey");
    ...
    detach() {
      if (!dart.test(this.owner[_nodes][$containsKey](this.id))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1464, 12, "ert(owner._nodes.containsKey");
      if (!!dart.test(this.owner[_detachedNodes].contains(this))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1465, 12, "ert(!owner._detachedNodes.contains(t");
      this.owner[_nodes][$remove](this.id);
      this.owner[_detachedNodes].add(this);
      super.detach();
      if (!(this.owner == null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1469, 12, "ert(owner == ");
      if (this[_children] != null) {
        for (let child of this[_children]) {
    ...
    [_markDirty]() {
      ...
      if (dart.test(this.attached)) {
        if (!!dart.test(this.owner[_detachedNodes].contains(this))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1492, 14, "ert(!owner._detachedNodes.contains(t");
        this.owner[_dirtyNodes].add(this);
      }
    }
    [_isDifferentFromCurrentSemanticAnnotation](config) {
      return this[_label] != config.label || this[_hint] != config.hint || this[_elevation] != config.elevation || this[_thickness] != config.thickness || this[_decreasedValue] != config.decreasedValue || this[_value] != config.value || this[_increasedValue] != config.increasedValue || this[_flags] != config[_flags] || !dart.equals(this[_textDirection], config.textDirection) || !dart.equals(this[_sortKey], config[_sortKey]) || !dart.equals(this[_textSelection], config[_textSelection]) || this[_scrollPosition] != config[_scrollPosition] || this[_scrollExtentMax] != config[_scrollExtentMax] || this[_scrollExtentMin] != config[_scrollExtentMin] || this[_actionsAsBits] != config[_actionsAsBits] || this.indexInParent != config.indexInParent || this.platformViewId != config.platformViewId || !dart.equals(this[_mergeAllDescendantsIntoThisNode], config.isMergingSemanticsOfDescendants);
    }
    isTagged(tag) {
    ...
    updateWith(opts) {
      ...
      if (!(config.platformViewId == null || dart.test(childrenInInversePaintOrder[$isEmpty]))) dart.assertFailed("SemanticsNodes with children must not specify a platformViewId.", "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1754, 7, "    config.platformViewId == null || childrenInInversePaintOrder.isE");
    ...
    getSemanticsData() {
      ...
      if (dart.test(this.mergeAllDescendantsIntoThisNode)) {
        this[_visitDescendants](dart.fn(node => {
          if (!dart.test(node.isMergedIntoParent)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1841, 16, "ert(node.isMergedIntoPa");
    ...
    [_addToUpdate](builder, customSemanticsActionIdsUpdate) {
      ...
      if (!dart.test(this[_dirty])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 1935, 12, "ert(_d");
      ...
      if (dart.equals((t2 = data.customSemanticsActionIds, t2 == null ? null : t2[$isNotEmpty]), true)) {
      ...
      builder.updateNode({id: this.id, flags: data.flags, actions: data.actions, rect: data.rect, label: data.label, value: data.value, decreasedValue: data.decreasedValue, increasedValue: data.increasedValue, hint: data.hint, textDirection: data.textDirection, textSelectionBase: data.textSelection != null ? data.textSelection.baseOffset : -1, textSelectionExtent: data.textSelection != null ? data.textSelection.extentOffset : -1, platformViewId: (t2$ = data.platformViewId, t2$ == null ? -1 : t2$), scrollChildren: (t2$0 = data.scrollChildCount, t2$0 == null ? 0 : t2$0), scrollIndex: (t2$1 = data.scrollIndex, t2$1 == null ? 0 : t2$1), scrollPosition: (t2$2 = data.scrollPosition, t2$2 == null ? 0 / 0 : t2$2), scrollExtentMax: (t2$3 = data.scrollExtentMax, t2$3 == null ? 0 / 0 : t2$3), scrollExtentMin: (t2$4 = data.scrollExtentMin, t2$4 == null ? 0 / 0 : t2$4), transform: (t2$6 = (t2$5 = data.transform, t2$5 == null ? null : t2$5.storage), t2$6 == null ? semantics.SemanticsNode._kIdentityTransform : t2$6), elevation: data.elevation, thickness: data.thickness, childrenInTraversalOrder: childrenInTraversalOrder, childrenInHitTestOrder: childrenInHitTestOrder, additionalActions: (t2$7 = customSemanticsActionIds, t2$7 == null ? semantics.SemanticsNode._kEmptyCustomSemanticsActionsList : t2$7)});
      this[_dirty] = false;
    }
    ...
    debugFillProperties(properties) {
      ...
      properties.add(new (IterablePropertyOfString()).new("tags", (t2 = this.tags, t2 == null ? null : t2[$map](core.String, dart.fn(tag => tag.name, SemanticsTagToString()))), {defaultValue: null}));
      let actions = (t2$ = this[_actions][$keys][$map](core.String, dart.fn(action => diagnostics.describeEnum(action), SemanticsActionToString()))[$toList](), t2$[$sort](), t2$);
      ...
      if (dart.equals((t2$0 = this[_textSelection], t2$0 == null ? null : t2$0.isValid), true)) properties.add(new diagnostics.MessageProperty.new("text selection", "[" + dart.str(this[_textSelection].start) + ", " + dart.str(this[_textSelection].end) + "]"));
      properties.add(new diagnostics.IntProperty.new("platformViewId", this.platformViewId, {defaultValue: null}));
      properties.add(new diagnostics.IntProperty.new("scrollChildren", this.scrollChildCount, {defaultValue: null}));
      properties.add(new diagnostics.IntProperty.new("scrollIndex", this.scrollIndex, {defaultValue: null}));
      properties.add(new diagnostics.DoubleProperty.new("scrollExtentMin", this.scrollExtentMin, {defaultValue: null}));
    ...
    toStringDeep(opts) {
      ...
      if (!(childOrder != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2141, 12, "\n    assert(childO");
    ...
    toDiagnosticsNode(opts) {
      ...
      let style = opts && 'style' in opts ? opts.style : C5 || CT.C5;
      let childOrder = opts && 'childOrder' in opts ? opts.childOrder : C4 || CT.C4;
    ...
    debugDescribeChildren(opts) {
      let childOrder = opts && 'childOrder' in opts ? opts.childOrder : C6 || CT.C6;
    ...
    debugListChildrenInOrder(childOrder) {
      if (!(childOrder != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2168, 12, "\n    assert(childO");
      if (this[_children] == null) return C2 || CT.C2;
      switch (childOrder) {
        case C6 || CT.C6:
        {
      ...
      if (!false) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2178, 12, "\n    ");
      return null;
    }
  };
  ...
  const key$ = Symbol("SemanticsNode.key");
  const id = Symbol("SemanticsNode.id");
  const parentSemanticsClipRect = Symbol("SemanticsNode.parentSemanticsClipRect");
  const parentPaintClipRect = Symbol("SemanticsNode.parentPaintClipRect");
  const elevationAdjustment = Symbol("SemanticsNode.elevationAdjustment");
  const indexInParent = Symbol("SemanticsNode.indexInParent");
  const tags = Symbol("SemanticsNode.tags");
  ...
  (semantics.SemanticsHintOverrides.new = function(opts) {
    ...
    if (!(onTapHint !== "")) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 504, 15, "onTapHint != ''");
    if (!(onLongPressHint !== "")) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 505, 15, "onLongPressHint != ''");
  ...
  const onTapHint$ = Symbol("SemanticsHintOverrides.onTapHint");
  const onLongPressHint$ = Symbol("SemanticsHintOverrides.onLongPressHint");
  ...
  const enabled$ = Symbol("SemanticsProperties.enabled");
  const checked$ = Symbol("SemanticsProperties.checked");
  const toggled$ = Symbol("SemanticsProperties.toggled");
  const selected$ = Symbol("SemanticsProperties.selected");
  const button$ = Symbol("SemanticsProperties.button");
  const header$ = Symbol("SemanticsProperties.header");
  const textField$ = Symbol("SemanticsProperties.textField");
  const readOnly$ = Symbol("SemanticsProperties.readOnly");
  const focused$ = Symbol("SemanticsProperties.focused");
  const inMutuallyExclusiveGroup$ = Symbol("SemanticsProperties.inMutuallyExclusiveGroup");
  const hidden$ = Symbol("SemanticsProperties.hidden");
  const obscured$ = Symbol("SemanticsProperties.obscured");
  const multiline$ = Symbol("SemanticsProperties.multiline");
  const scopesRoute$ = Symbol("SemanticsProperties.scopesRoute");
  const namesRoute$ = Symbol("SemanticsProperties.namesRoute");
  const image$ = Symbol("SemanticsProperties.image");
  const liveRegion$ = Symbol("SemanticsProperties.liveRegion");
  const label$1 = Symbol("SemanticsProperties.label");
  const value$0 = Symbol("SemanticsProperties.value");
  const increasedValue$0 = Symbol("SemanticsProperties.increasedValue");
  const decreasedValue$0 = Symbol("SemanticsProperties.decreasedValue");
  const hint$1 = Symbol("SemanticsProperties.hint");
  const hintOverrides$ = Symbol("SemanticsProperties.hintOverrides");
  const textDirection$1 = Symbol("SemanticsProperties.textDirection");
  const sortKey$ = Symbol("SemanticsProperties.sortKey");
  const onTap$ = Symbol("SemanticsProperties.onTap");
  const onLongPress$ = Symbol("SemanticsProperties.onLongPress");
  const onScrollLeft$ = Symbol("SemanticsProperties.onScrollLeft");
  const onScrollRight$ = Symbol("SemanticsProperties.onScrollRight");
  const onScrollUp$ = Symbol("SemanticsProperties.onScrollUp");
  const onScrollDown$ = Symbol("SemanticsProperties.onScrollDown");
  const onIncrease$ = Symbol("SemanticsProperties.onIncrease");
  const onDecrease$ = Symbol("SemanticsProperties.onDecrease");
  const onCopy$ = Symbol("SemanticsProperties.onCopy");
  const onCut$ = Symbol("SemanticsProperties.onCut");
  const onPaste$ = Symbol("SemanticsProperties.onPaste");
  const onMoveCursorForwardByCharacter$ = Symbol("SemanticsProperties.onMoveCursorForwardByCharacter");
  const onMoveCursorBackwardByCharacter$ = Symbol("SemanticsProperties.onMoveCursorBackwardByCharacter");
  const onMoveCursorForwardByWord$ = Symbol("SemanticsProperties.onMoveCursorForwardByWord");
  const onMoveCursorBackwardByWord$ = Symbol("SemanticsProperties.onMoveCursorBackwardByWord");
  const onSetSelection$ = Symbol("SemanticsProperties.onSetSelection");
  const onDidGainAccessibilityFocus$ = Symbol("SemanticsProperties.onDidGainAccessibilityFocus");
  const onDidLoseAccessibilityFocus$ = Symbol("SemanticsProperties.onDidLoseAccessibilityFocus");
  const onDismiss$ = Symbol("SemanticsProperties.onDismiss");
  const customSemanticsActions$ = Symbol("SemanticsProperties.customSemanticsActions");
  ...
  (semantics._BoxEdge.new = function(opts) {
    ...
    this.offset = offset;
    this.node = node;
    if (!(isLeadingEdge != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2196, 15, "}) : assert(isLeading");
    if (!(offset != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2197, 15, "     assert(of");
    if (!offset[$isFinite]) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2198, 15, "     assert(off");
    if (!(node != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2199, 15, "     assert(");
    ;
  ...
  semantics._SemanticsSortGroup = class _SemanticsSortGroup extends core.Comparable {
    ...
    sortedWithinKnot() {
      ...
      let startNodes = (t2 = this.nodes[$toList](), t2[$sort](dart.fn((a, b) => {
      ...
      }, SemanticsNodeAndSemanticsNodeToint())), t2);
      function search(id) {
  ...
  (semantics._SemanticsSortGroup.new = function(opts) {
    ...
    this.textDirection = textDirection;
    if (!(startOffset != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2233, 15, "}) : assert(startOf");
    ;
  ...
  semantics._TraversalSortNode = class _TraversalSortNode extends core.Object {
    compareTo(other) {
      ...
      if (this.sortKey == null || (t2 = other, t2 == null ? null : t2.sortKey) == null) {
  ...
  (semantics._TraversalSortNode.new = function(opts) {
    ...
    if (!(node != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2457, 14, "   : assert(");
    if (!(position != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2458, 14, "     assert(posi");
    ;
  ...
  semantics.SemanticsOwner = class SemanticsOwner extends change_notifier.ChangeNotifier {
    ...
    sendSemanticsUpdate() {
      ...
      while (dart.test(this[_dirtyNodes][$isNotEmpty])) {
        ...
        for (let node of localDirtyNodes) {
          if (!dart.test(node[_dirty])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2520, 16, "     assert");
          if (!(node.parent == null || !dart.test(node.parent.isPartOfNodeMerging) || dart.test(node.isMergedIntoParent))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2521, 16, "     assert(node.parent == null || !node.parent.isPartOfNodeMerging || node.isMerg");
          if (dart.test(node.isPartOfNodeMerging)) {
            if (!(dart.test(node.mergeAllDescendantsIntoThisNode) || node.parent != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2523, 18, "     assert(node.mergeAllDescendantsIntoThisNode || node.pa");
      ...
      for (let node of visitedNodes) {
        if (!!dart.equals((t2 = node.parent, t2 == null ? null : t2[_dirty]), true)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2533, 14, "     assert(node.parent?._d");
      ...
      for (let actionId of customSemanticsActionIds) {
        ...
        builder.updateCustomAction({id: actionId, label: action.label, hint: action.hint, overrideId: (t2$0 = (t2$ = action.action, t2$ == null ? null : t2$.index), t2$0 == null ? -1 : t2$0)});
      }
    ...
    performAction(id, action, args) {
      ...
      if (!(action != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2580, 12, "\n    assert(ac");
    ...
    [_getSemanticsActionHandlerForPosition](node, position, action) {
      ...
      if (dart.test(node.mergeAllDescendantsIntoThisNode)) {
        ...
        return (t2 = result, t2 == null ? null : t2[_actions])[$_get](action);
      }
    ...
    performActionAt(position, action, args) {
      if (args === void 0) args = null;
      if (!(action != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2630, 12, "\n    assert(ac");
  ...
  semantics.SemanticsConfiguration = class SemanticsConfiguration extends core.Object {
    ...
    set isSemanticBoundary(value) {
      if (!(!dart.test(this.isMergingSemanticsOfDescendants) || dart.test(value))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2668, 12, "\n    assert(!isMergingSemanticsOfDescenda");
    ...
    [_addAction](action, handler) {
      if (!(handler != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2730, 12, "\n    assert(han");
    ...
    [_addArgumentlessAction](action, handler) {
      if (!(handler != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2742, 12, "\n    assert(han");
      this[_addAction](action, dart.fn(args => {
        if (!(args == null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2744, 14, "     assert(");
        handler();
      }, dynamicToNull()));
    }
    get onTap() {
    ...
    set onMoveCursorForwardByCharacter(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2979, 12, "\n    assert(v");
      this[_addAction](ui.SemanticsAction.moveCursorForwardByCharacter, dart.fn(args => {
        let extentSelection = core.bool._check(args);
        if (!(extentSelection != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2982, 14, "     assert(extentSelec");
    ...
    set onMoveCursorBackwardByCharacter(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2998, 12, "\n    assert(v");
      this[_addAction](ui.SemanticsAction.moveCursorBackwardByCharacter, dart.fn(args => {
        let extentSelection = core.bool._check(args);
        if (!(extentSelection != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3001, 14, "     assert(extentSelec");
        value(extentSelection);
      }, dynamicToNull()));
    ...
    set onMoveCursorForwardByWord(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3017, 12, "\n    assert(v");
      this[_addAction](ui.SemanticsAction.moveCursorForwardByWord, dart.fn(args => {
        let extentSelection = core.bool._check(args);
        if (!(extentSelection != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3020, 14, "     assert(extentSelec");
        value(extentSelection);
      }, dynamicToNull()));
      this[_onMoveCursorForwardByCharacter] = value;
    }
    ...
    set onMoveCursorBackwardByWord(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3036, 12, "\n    assert(v");
      this[_addAction](ui.SemanticsAction.moveCursorBackwardByWord, dart.fn(args => {
        let extentSelection = core.bool._check(args);
        if (!(extentSelection != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3039, 14, "     assert(extentSelec");
        value(extentSelection);
      }, dynamicToNull()));
      this[_onMoveCursorBackwardByCharacter] = value;
    }
    ...
    set onSetSelection(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3055, 12, "\n    assert(v");
      this[_addAction](ui.SemanticsAction.setSelection, dart.fn(args => {
        if (!(args != null && core.Map.is(args))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3057, 14, "     assert(args != null &&");
        let selection = MapOfString$int()._check(dart.dgsend(args, [core.String, core.int], 'cast', []));
        if (!(selection != null && selection[$_get]("base") != null && selection[$_get]("extent") != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3059, 14, "     assert(selection != null && selection['base'] != null && selection['exte");
    ...
    set sortKey(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3138, 12, "\n    assert(v");
      this[_sortKey] = value;
      this[_hasBeenAnnotated] = true;
    }
    get indexInParent() {
    ...
    set isMergingSemanticsOfDescendants(value) {
      if (!dart.test(this.isSemanticBoundary)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3202, 12, "\n    assert(isSema");
    ...
    set label(label) {
      if (!(label != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3242, 12, "\n    assert(l");
      this[_label] = label;
      this[_hasBeenAnnotated] = true;
    }
    get value() {
    ...
    set value(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3265, 12, "\n    assert(v");
      this[_value] = value;
      this[_hasBeenAnnotated] = true;
    }
    get decreasedValue() {
    ...
    set decreasedValue(decreasedValue) {
      if (!(decreasedValue != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3280, 12, "\n    assert(decreasedV");
    ...
    set increasedValue(increasedValue) {
      if (!(increasedValue != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3295, 12, "\n    assert(increasedV");
    ...
    set hint(hint) {
      if (!(hint != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3311, 12, "\n    assert(");
      this[_hint] = hint;
      this[_hasBeenAnnotated] = true;
    }
    get hintOverrides() {
    ...
    set elevation(value) {
      if (!(value != null && dart.notNull(value) >= 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3332, 12, "\n    assert(value != null && ");
    ...
    set thickness(value) {
      if (!(value != null && dart.notNull(value) >= 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3349, 12, "\n    assert(value != null && ");
    ...
    set textSelection(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3575, 12, "\n    assert(v");
    ...
    set scrollPosition(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3593, 12, "\n    assert(v");
    ...
    set scrollExtentMax(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3609, 12, "\n    assert(v");
    ...
    set scrollExtentMin(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3625, 12, "\n    assert(v");
    ...
    absorb(child) {
      if (!!dart.test(this.explicitChildNodes)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3710, 12, "\n    assert(!explic");
    ...
    copy() {
      let t2;
      t2 = new semantics.SemanticsConfiguration.new();
      t2[_isSemanticBoundary] = this[_isSemanticBoundary];
      t2.explicitChildNodes = this.explicitChildNodes;
      t2.isBlockingSemanticsOfPreviouslyPaintedNodes = this.isBlockingSemanticsOfPreviouslyPaintedNodes;
      t2[_hasBeenAnnotated] = this[_hasBeenAnnotated];
      t2[_isMergingSemanticsOfDescendants] = this[_isMergingSemanticsOfDescendants];
      t2[_textDirection] = this[_textDirection];
      t2[_sortKey] = this[_sortKey];
      t2[_label] = this[_label];
      t2[_increasedValue] = this[_increasedValue];
      t2[_value] = this[_value];
      t2[_decreasedValue] = this[_decreasedValue];
      t2[_hint] = this[_hint];
      t2[_hintOverrides] = this[_hintOverrides];
      t2[_elevation] = this[_elevation];
      t2[_thickness] = this[_thickness];
      t2[_flags] = this[_flags];
      t2[_tagsForChildren] = this[_tagsForChildren];
      t2[_textSelection] = this[_textSelection];
      t2[_scrollPosition] = this[_scrollPosition];
      t2[_scrollExtentMax] = this[_scrollExtentMax];
      t2[_scrollExtentMin] = this[_scrollExtentMin];
      t2[_actionsAsBits] = this[_actionsAsBits];
      t2[_indexInParent] = this.indexInParent;
      t2[_scrollIndex] = this[_scrollIndex];
      t2[_scrollChildCount] = this[_scrollChildCount];
      t2[_platformViewId] = this[_platformViewId];
      t2[_actions][$addAll](this[_actions]);
      t2[_customSemanticsActions][$addAll](this[_customSemanticsActions]);
      return t2;
    }
  };
  ...
  const explicitChildNodes = Symbol("SemanticsConfiguration.explicitChildNodes");
  const isBlockingSemanticsOfPreviouslyPaintedNodes = Symbol("SemanticsConfiguration.isBlockingSemanticsOfPreviouslyPaintedNodes");
  ...
  semantics.DebugSemanticsDumpOrder.inverseHitTest = C6 || CT.C6;
  semantics.DebugSemanticsDumpOrder.traversalOrder = C4 || CT.C4;
  semantics.DebugSemanticsDumpOrder.values = C7 || CT.C7;
  semantics.SemanticsSortKey = class SemanticsSortKey extends diagnostics.Diagnosticable {
    ...
    compareTo(other) {
      ...
      if (!dart.equals(this[$runtimeType], dart.runtimeType(other))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3871, 12, "\n    assert(runtimeType == other");
      if (!(this.name == other.name)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3872, 12, "\n    assert(name =");
  ...
  const name$0 = Symbol("SemanticsSortKey.name");
  ...
  (semantics.OrdinalSortKey.new = function(order, opts) {
    let name = opts && 'name' in opts ? opts.name : null;
    this[order$] = order;
    if (!(order != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3912, 15, "}) : assert(o");
    if (!(order !== 0 / 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3913, 15, "     assert(order !");
    if (!(dart.notNull(order) > -1 / 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3914, 15, "     assert(order > double.nega");
    if (!(dart.notNull(order) < 1 / 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 3915, 15, "     assert(order < dou");
  ...
  const order$ = Symbol("OrdinalSortKey.order");
  ...
  semantics._childrenInDefaultOrder = function _childrenInDefaultOrder(children, textDirection) {
    ...
    for (let child of children) {
      if (!dart.test(child.rect.isFinite)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/semantics/semantics.dart", 2402, 12, "\n    assert(child.r");
      let childRect = child.rect.deflate(0.1);
