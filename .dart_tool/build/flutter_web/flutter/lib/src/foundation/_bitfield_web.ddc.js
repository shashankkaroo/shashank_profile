define(['dart_sdk', 'packages/typed_data/typed_buffers'], function(dart_sdk, packages__typed_data__typed_buffers) {
  ...
  diagnostics$.DiagnosticsProperty$ = dart.generic(T => {
    class DiagnosticsProperty extends diagnostics$.DiagnosticsNode {
      ...
      [_addTooltip](text) {
        if (!(text != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2617, 12, "tion parentC");
      ...
      [_maybeCacheValue]() {
        ...
        if (!(this[_computeValue] != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2687, 12, "llback],\n  /// [value");
        try {
    ...
    (DiagnosticsProperty.new = function(name, value, opts) {
      ...
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2459, 15, "perty causes it ");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2460, 15, "r higher\n  /// level.");
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2461, 15, "the property ");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2462, 15, " [missingIfNu");
    ...
    (DiagnosticsProperty.lazy = function(name, computeValue, opts) {
      ...
      this[allowWrap$] = allowWrap;
      this[allowNameWrap$] = allowNameWrap;
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2505, 15, "s it to have a l");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2506, 15, "/// level. For exampl");
      if (!(dart.equals(defaultValue, diagnostics$.kNoDefaultValue) || T.is(defaultValue))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2507, 15, "mputeValue` throws an exception, [level]\n  /// will ");
      if (!(missingIfNull != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2508, 15, "agnosticLevel.error].");
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2509, 15, "perty.lazy(\n ");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2510, 15, "   ComputePro");
      this[_description] = description;
    ...
    class DiagnosticableMixin extends Object {
      ...
      toString(opts) {
        ...
        if (!dart.test(dart.fn(() => {
          ...
          return true;
        }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2987, 12, "    class already describes the children of a node properly or a node has\n///    no children.\n///  * [DiagnosticsProperty], which should b");
        t3 = fullString;
  ...
  diagnostics$.DiagnosticableNode$ = dart.generic(T => {
    ...
    (DiagnosticableNode.new = function(opts) {
      ...
      this[value$] = value;
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2774, 15, "if (object is");
  ...
  diagnostics$.ObjectFlagProperty$ = dart.generic(T => {
    ...
    (ObjectFlagProperty.new = function(name, value, opts) {
      ...
      if (!(ifPresent != null || ifNull != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2334, 15, "vides similar functionality describ");
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2335, 15, "  a [value] is t");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2336, 15, "ss ObjectFlag");
    ...
    (ObjectFlagProperty.has = function(name, value, opts) {
      let level = opts && 'level' in opts ? opts.level : C1 || CT.C1;
      if (!(name != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2355, 15, " this.ifPres");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2356, 15, "fNull,\n    bo");
  ...
  diagnostics$.describeEnum = function describeEnum(enumEntry) {
    ...
    if (!(indexOfDot !== -1 && indexOfDot < description.length - 1)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2882, 10, "e}#${shortHash(object)}';\n\n// This method exists as a w");
