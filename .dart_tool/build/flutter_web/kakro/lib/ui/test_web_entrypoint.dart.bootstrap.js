...
let modulePaths = {
 ...
 "packages/kakro/ui/test_web_entrypoint": "packages/kakro/ui/test_web_entrypoint.ddc",
...
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'test_web_entrypoint.digests',
...
define("test_web_entrypoint.dart.bootstrap", ["packages/kakro/ui/test_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.lib__ui__test_web_entrypoint || app.test_web_entrypoint).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:kakro/ui/test_web_entrypoint.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("test_web_entrypoint.dart.bootstrap", {
    "test_web_entrypoint.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
