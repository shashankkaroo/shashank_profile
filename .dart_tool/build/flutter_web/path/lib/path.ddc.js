define(['dart_sdk'], function(dart_sdk) {
  ...
  (path_set.PathSet.of = function(other, opts) {
    let t2;
    let context = opts && 'context' in opts ? opts.context : null;
    this[_inner] = (t2 = path_set.PathSet._create(context), t2.addAll(other), t2);
    path_set.PathSet.__proto__.new.call(this);
    ;
  }).prototype = path_set.PathSet.prototype;
  ...
  path_map.PathMap$ = dart.generic(V => {
    ...
    (PathMap.of = function(other, opts) {
      let t2;
      let context = opts && 'context' in opts ? opts.context : null;
      PathMap.__proto__.new.call(this, (t2 = path_map.PathMap._create(V, context), t2[$addAll](other), t2));
      ;
    }).prototype = PathMap.prototype;
  ...
  context.Context = class Context extends core.Object {
    ...
    relative(path, opts) {
      ...
      let fromParsed = (t2 = this[_parse](from), t2.normalize(), t2);
      let pathParsed = (t2$ = this[_parse](path), t2$.normalize(), t2$);
    ...
    [_isWithinOrEqualsFast](parent, child) {
      ...
      if (childIndex === child.length) {
        ...
        let direction = this[_pathDirection](parent, (t3 = lastParentSeparator, t3 == null ? dart.notNull(parentRootLength) - 1 : t3));
  ...
  context._validateArgList = function _validateArgList(method, args) {
    for (let i = 1; i < dart.notNull(args[$length]); i = i + 1) {
      ...
      let numArgs = null;
      for (let t3 = numArgs = args[$length]; dart.notNull(numArgs) >= 1; numArgs = dart.notNull(numArgs) - 1) {
